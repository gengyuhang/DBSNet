...
class benchmark_data(Dataset):
    ...
    def __init__(self, data_dir, task, transform=None):
        ...
        #self.Validation_Gt = scipy.io.loadmat(self.data_dir + 'Noisy1.mat')['data'][0]
        self.Validation_Gt = scipy.io.loadmat(self.data_dir + 'BSD68_GT.mat')['data'][0]
        #print("Validation_Gt shape:", self.Validation_Gt.shape)
        #self.Validation_Noisy=scipy.io.loadmat(self.data_dir+'ValidationNoisyBlocksSrgb.mat')['ValidationNoisyBlocksSrgb']
        self.Validation_Noisy=scipy.io.loadmat(self.data_dir+'BSD68_gs25_1.mat')['data'][0]
        #self.Validation_Noisy = scipy.io.loadmat(self.data_dir + 'Noisy2.mat')['data'][0]
        # print("Validation_Noisy shape:", self.Validation_Noisy.shape)

#        self.Validation_Gt = self.Validation_Gt.reshape([-1, 256, 256, 3])
#         print("Reshaped Validation_Gt shape:", self.Validation_Gt.shape)

#       self.Validation_Noisy = self.Validation_Noisy.reshape([-1, 256, 256, 3])
#         # print("Reshaped Validation_Noisy shape:", self.Validation_Noisy.shape)

        '''
        Validation_Gt shape: (40, 32, 256, 256, 3)
        Validation_Noisy shape: (40, 32, 256, 256, 3)
        Reshaped Validation_Gt shape: (1280, 256, 256, 3)
        Reshaped Validation_Noisy shape: (1280, 256, 256, 3)
        '''
